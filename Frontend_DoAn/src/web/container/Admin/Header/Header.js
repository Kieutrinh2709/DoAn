                ...
                >
                    <div>
                        ...
                        <div className="row">
                            <div className="col-md-6">
                                ...
                                <p className="mb-2"><span>Công ty:&nbsp;&nbsp;&nbsp;&nbsp;</span><span className="tt-user">MemoriesTravel</span></p>
                            ...
                            <div className="col-md-6">
                                ...
                                <p className="mb-2"><span>Website:&nbsp;&nbsp;&nbsp;&nbsp;</span><span className="tt-user">MemoriesTravel.com.vn</span></p>
                            </div>
                    ...
                    <div className="row">
                        ...
                        <div className="col-md-6">
                            ...
                            <p className="mb-2"><span>Giám sát:&nbsp;&nbsp;&nbsp;&nbsp;</span><span className="tt-user">Kiều Trinh</span></p>
                        </div>
